...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="{{asset('image/logo/logo.png')}}" alt="AdminLTELogo" height="150" width="150">
  </div>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/dashboard" class="brand-link">
      <img src="{{asset('image/logo/logo.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="/foods" class="nav-link">
                    <i class="far fa-cutlery nav-icon"></i>
                    <p>Menu</p>
                  </a>
                </li>
                <li class="nav-item">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2022 Hawari Dev.</strong>
    All rights reserved.
...
<script src="{{asset('template/plugins/jqvmap/maps/jquery.vmap.indonesia.js')}}"></script>
<!-- jQuery Knob Chart -->
...
<script>
$(document).ready(function() {
    var judul = document.getElementById(isiToast).value
      $(document).Toasts('create', {
        class: 'bg-success',
        title: 'Success',
        body: 'Data Berhasil Di Input'
      })
    });
</script>
@endif
...
<script>
    ...
    $('#formMenu').validate({
        ...
        messages: {
          ...
          harga: {
            required: "Masukan Harga Menu",
          },
          kategori: {
            required: "Pilih Kategori Menu",
          },
          file: {
            required: "Masukan Foto Produk",
          }
        },
        errorElement: 'span',
